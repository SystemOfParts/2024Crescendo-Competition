...
public class FAST_AutoBlueCenterThreeNoteSouth extends SequentialCommandGroup {
  /** Creates a new ThreeNoteAuto. */
  public FAST_AutoBlueCenterThreeNoteSouth(
    ArmSubsystem m_a,
    IntakeSubsystem m_i,
    ...
    addCommands(
      ...
      new AutoIntakeMoveShoot(true, Orientations.AUTO_PODIUM, "a_b_2_to_3_SAN", null, 0.5, 0.5, m_a, m_s, m_i),
