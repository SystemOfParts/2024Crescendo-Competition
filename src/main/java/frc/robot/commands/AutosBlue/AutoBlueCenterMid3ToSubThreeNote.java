...
public class AutoBlueCenterMid3ToSubThreeNote extends SequentialCommandGroup {
  /** Creates a new TwoNoteAuto. */
  public AutoBlueCenterMid3ToSubThreeNote(
    ArmSubsystem m_arm,
    ...
    addCommands(
      ...
      new ParallelCommandGroup(
        ...
        new RunTrajectorySequenceRobotAtStartPoint("BlueCenterThreeToMid3AndSub"),
