...
public class FAST_AutoBlueSouthTwoNoteMid4 extends SequentialCommandGroup {
  /** Creates a new ThreeNoteAuto. */
  public FAST_AutoBlueSouthTwoNoteMid4(
    ArmSubsystem m_a,
    IntakeSubsystem m_i,
    ...
    addCommands(
      ...
      new AutoIntakeMoveShoot(true, Orientations.AUTO_PODIUM, "a_b_South_Shoot_Mid4", null, 0.5, 0.5, m_a, m_s, m_i),
