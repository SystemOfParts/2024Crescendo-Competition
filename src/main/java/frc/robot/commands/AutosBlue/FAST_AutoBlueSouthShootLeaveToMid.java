...
public class FAST_AutoBlueSouthShootLeaveToMid extends SequentialCommandGroup {
  /** Creates a new ThreeNoteAuto. */
  public FAST_AutoBlueSouthShootLeaveToMid(
    ArmSubsystem m_a,
    IntakeSubsystem m_i,
    ...
    addCommands(
      ...
      new FASTRunTrajectorySequenceRobotAtStartPoint("a_b_South_Shoot_Leave_Mid3"),
