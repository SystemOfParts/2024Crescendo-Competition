...
public class AutoBlueSouthThreeNoteMid5 extends SequentialCommandGroup {
  /** Creates a new TwoNoteAuto. */
  public AutoBlueSouthThreeNoteMid5(
    ArmSubsystem m_arm,
    ...
    addCommands(
      ...
      new ParallelCommandGroup(
        ...
        new RunTrajectorySequenceRobotAtStartPoint("BlueSouthThreeNotePart1")
      ),
      ...
      new ParallelCommandGroup(
        new AutoMoveToOrientationCommand(m_arm, m_shooter, m_intake, Orientations.AUTO_INTAKE),
        new RunTrajectorySequenceRobotAtStartPoint("BlueSouthThreeNotePart2-Mid5")
      ),
