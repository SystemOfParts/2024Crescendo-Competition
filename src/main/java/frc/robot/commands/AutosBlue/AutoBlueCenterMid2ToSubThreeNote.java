...
public class AutoBlueCenterMid2ToSubThreeNote extends SequentialCommandGroup {
  /** Creates a new TwoNoteAuto. */
  public AutoBlueCenterMid2ToSubThreeNote(
    ArmSubsystem m_arm,
    ...
    addCommands(
      ...
      new ParallelCommandGroup(
        ...
        new RunTrajectorySequenceRobotAtStartPoint("BlueCenterThreeToMid2AndSub"),
