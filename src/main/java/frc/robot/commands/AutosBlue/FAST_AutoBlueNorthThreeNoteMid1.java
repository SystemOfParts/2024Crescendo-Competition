...
public class FAST_AutoBlueNorthThreeNoteMid1 extends SequentialCommandGroup {
  /** Creates a new ThreeNoteAuto. */
  public FAST_AutoBlueNorthThreeNoteMid1(
    ArmSubsystem m_a,
    IntakeSubsystem m_i,
    ...
    addCommands(
      ...
      new AutoIntakeMoveShoot(true, Orientations.AUTO_PODIUM, "a_b_North_3Note_North_Center_1", null, 0.5, 0.5, m_a, m_s, m_i),
