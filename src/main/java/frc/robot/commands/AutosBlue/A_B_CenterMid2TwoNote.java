...
public class A_B_CenterMid2TwoNote extends SequentialCommandGroup {
  /** Creates a new TwoNoteAuto. */
  public A_B_CenterMid2TwoNote(
    ArmSubsystem m_arm,
    ...
    addCommands(
      ...
      new ParallelCommandGroup(
        ...
        new RunTrajectorySequenceRobotAtStartPoint("BlueCenterThreeToMidline2Part1")
      ),
