...
public class AutoBlueCenterMid2And3ThreeNote extends SequentialCommandGroup {
  public AutoBlueCenterMid2And3ThreeNote(
    ArmSubsystem m_arm,
    ...
    addCommands(
      ...
      new ParallelCommandGroup(
        ...
        new RunTrajectorySequenceRobotAtStartPoint("BlueCenterThreeToMid2AndPod"),
