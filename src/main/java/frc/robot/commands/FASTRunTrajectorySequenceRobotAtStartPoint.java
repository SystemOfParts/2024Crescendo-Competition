...
import frc.robot.commands.PathingCommands.AutonomousTrajectoryRioCommand;

// NOTE:  Consider using this command inline, rather than writing a subclass.  For more
// information, see:
// https://docs.wpilib.org/en/stable/docs/software/commandbased/convenience-features.html
public class FASTRunTrajectorySequenceRobotAtStartPoint extends SequentialCommandGroup {
   ...
   */
  public FASTRunTrajectorySequenceRobotAtStartPoint(String trajectory, double maxVelocity, double maxAcceleration, boolean reversed) {
   ...
   */
  public FASTRunTrajectorySequenceRobotAtStartPoint(String trajectory, boolean reversed) {

    //this(trajectory, 0.5, 0.05, reversed);
    this(trajectory, Constants.SwerveChassis.MAX_HIGH_VELOCITY, Constants.SwerveChassis.MAX_HIGH_ACCELERATION, reversed);
