...
public class ShootUsingAprilTag extends SequentialCommandGroup {
  ...
  public ShootUsingAprilTag() {
    ...
    //    new DeferredCommand(() -> new PrintCommand("Shooting Distance : " + (PHTNVisionSubsystem.getShootingDistance() - 1.1)), 
    //    Set.of()).andThen( 
    //   new DeferredCommand(

    //       () -> new AprilTagShootingSequence(PHTNVisionSubsystem.distanceToShoot - 1.1), 
    //       Set.of())),
