...
public class AutoRedNorthTwoNoteTRAP extends SequentialCommandGroup {
  /** Creates a new TwoNoteAuto. */
  public AutoRedNorthTwoNoteTRAP(
    ArmSubsystem m_arm,
    ...
    addCommands(
      ...
      new ParallelCommandGroup(
        ...
        new RunTrajectorySequenceRobotAtStartPoint("RedNorthTwoNotePart1")
      ),

      new RunTrajectorySequenceRobotAtStartPoint("RedNorthTwoNotePart2TRAP"),
