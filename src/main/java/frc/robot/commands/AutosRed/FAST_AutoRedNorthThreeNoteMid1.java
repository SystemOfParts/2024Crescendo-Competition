...
public class FAST_AutoRedNorthThreeNoteMid1 extends SequentialCommandGroup {
  /** Creates a new ThreeNoteAuto. */
  public FAST_AutoRedNorthThreeNoteMid1(
    ArmSubsystem m_a,
    IntakeSubsystem m_i,
    ...
    addCommands(
      ...
      new AutoIntakeMoveShoot(true, Orientations.AUTO_PODIUM, "a_r_North_2Note_SAN", null, 0.5, 0.5, m_a, m_s, m_i),
      new AutoIntakeMoveShoot(true, Orientations.AUTO_PODIUM, "a_r_North_3Note_Center1", null, 0.5, 0.5, m_a, m_s, m_i),
