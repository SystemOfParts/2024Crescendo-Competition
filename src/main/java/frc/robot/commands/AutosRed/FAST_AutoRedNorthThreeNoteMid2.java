...
public class FAST_AutoRedNorthThreeNoteMid2 extends SequentialCommandGroup {
  /** Creates a new ThreeNoteAuto. */
  public FAST_AutoRedNorthThreeNoteMid2(
    ArmSubsystem m_a,
    IntakeSubsystem m_i,
    ...
    addCommands(
      ...
      new AutoIntakeMoveShoot(true, Orientations.AUTO_PODIUM, "a_r_North_3Note_Center2", null, 0.5, 0.5, m_a, m_s, m_i),
