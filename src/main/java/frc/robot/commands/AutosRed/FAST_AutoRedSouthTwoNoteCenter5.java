...
public class FAST_AutoRedSouthTwoNoteCenter5 extends SequentialCommandGroup {
  /** Creates a new ThreeNoteAuto. */
  public FAST_AutoRedSouthTwoNoteCenter5(
    ArmSubsystem m_a,
    IntakeSubsystem m_i,
    ...
    addCommands(
      ...
      new AutoIntakeMoveShoot(true, Orientations.AUTO_PODIUM, "a_r_South_2Note_Center5", null, 0.5, 0.5, m_a, m_s, m_i),
