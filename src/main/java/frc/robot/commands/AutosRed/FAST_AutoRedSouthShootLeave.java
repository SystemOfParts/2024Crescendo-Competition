...
public class FAST_AutoRedSouthShootLeave extends SequentialCommandGroup {
  /** Creates a new ThreeNoteAuto. */
  public FAST_AutoRedSouthShootLeave(
    ArmSubsystem m_a,
    IntakeSubsystem m_i,
    ...
    addCommands(
      ...
      new FASTRunTrajectorySequenceRobotAtStartPoint("a_r_South_Shoot_Leave"),
