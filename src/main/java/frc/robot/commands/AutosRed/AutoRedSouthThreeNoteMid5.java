...
public class AutoRedSouthThreeNoteMid5 extends SequentialCommandGroup {
  /** Creates a new TwoNoteAuto. */
  public AutoRedSouthThreeNoteMid5(
    ArmSubsystem m_arm,
    ...
    addCommands(
      ...
      new ParallelCommandGroup(
        new AutoMoveToOrientationCommand(m_arm, m_shooter, m_intake, Orientations.AUTO_INTAKE),
        new RunTrajectorySequenceRobotAtStartPoint("RedSouthThreeNotePart2-Mid5")
      ),
