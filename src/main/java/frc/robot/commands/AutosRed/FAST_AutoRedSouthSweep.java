...
public class FAST_AutoRedSouthSweep extends SequentialCommandGroup {
  /** Creates a new ThreeNoteAuto. */
  public FAST_AutoRedSouthSweep(
    ArmSubsystem m_a,
    IntakeSubsystem m_i,
    ...
    addCommands(
      ...
      new FASTRunTrajectorySequenceRobotAtStartPoint("a_r_South_Sweep"),
      new AutoMoveToOrientationCommand(m_a, m_s, m_i, Orientations.TRAVEL));
  }
}