...
public class FAST_AutoRedNorthShootLeave extends SequentialCommandGroup {
  /** Creates a new ThreeNoteAuto. */
  public FAST_AutoRedNorthShootLeave(
    ArmSubsystem m_a,
    IntakeSubsystem m_i,
    ...
    addCommands(
      ...
      new FASTRunTrajectorySequenceRobotAtStartPoint("a_r_North_Shoot_Leave"),
