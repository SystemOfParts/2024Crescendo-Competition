...
public class FAST_AutoRedNorthTwoNote extends SequentialCommandGroup {
  /** Creates a new ThreeNoteAuto. */
  public FAST_AutoRedNorthTwoNote(
    ArmSubsystem m_a,
    IntakeSubsystem m_i,
    ...
    addCommands(
      ...
      new FASTRunTrajectorySequenceRobotAtStartPoint("a_r_North_2Note_SAN_EndMove"),
