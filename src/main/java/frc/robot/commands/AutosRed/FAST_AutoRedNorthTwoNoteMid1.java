...
public class FAST_AutoRedNorthTwoNoteMid1 extends SequentialCommandGroup {
  public FAST_AutoRedNorthTwoNoteMid1(
    ArmSubsystem m_a,
    IntakeSubsystem m_i,
    ...
    addCommands(
      ...
      new AutoIntakeMoveShoot(true, Orientations.AUTO_PODIUM, "a_r_North_2Note_Center1", null, 0.5, 0.5, m_a, m_s, m_i),
